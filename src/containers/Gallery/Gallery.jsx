...
const Gallery = () => {
  ...
  const scroll = (direction) => {
    ...
    if (direction === "left"){
      current.scrollLeft -= 300; // if direction is left, we move the scroll 300px to the left by subtract
    }
    else {
      current.scrollLeft += 300; // Move scroll to the right 300px by adding
    }
  }
